...
output_file=summary_gvns.txt
echo GVNS >> $output_file
...
do
    ...
    python main.py --alg gvns --step first --alpha "$alpha_prob" --beta "$beta_prob" -k "$k_value" "$file" >> $output_file
done
