...
output_file=summary_GRASP_join2nodes.txt
echo GRASP: join2nodes >> output_file
...
do
    ...
    python main.py --alg grasp --nh jc --step first --iterations 30 --alpha "$alpha_prob" --beta "$beta_prob" -k "$k_value" "$file" >> $output_file
done
