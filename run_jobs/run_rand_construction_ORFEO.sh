...
output_file=summary_rc.txt
echo Randomized Construction >> output_file
...
do
    ...
    python main.py --alg rc --alpha "$alpha_prob" --beta "$beta_prob" -k "$k_value" "$file" >> $output_file
done
