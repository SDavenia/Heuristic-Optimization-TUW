...
output_file=summary_ls_swap2nodes.txt
echo Local Search: swap2nodes >> output_file
...
do
    ...
    python main.py --alg ls --nh s2 --step first --alpha "$alpha_prob" --beta "$beta_prob" -k "$k_value" "$file" >> $output_file
done
